    ...
    <main className="min-h-screen bg-[#020202] text-zinc-300 selection:bg-cyan-500/30 selection:text-cyan-200 font-sans overflow-x-hidden">
      ...
      <footer className="py-16 bg-black border-t border-white/10 text-center relative z-20">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <a href="mailto:sufiyan@exorbistech.online" className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-bold tracking-wide hover:shadow-[0_0_40px_rgba(34,211,238,0.4)] hover:-translate-y-1 transition-all duration-300 mb-12">
            Email Me Directly
